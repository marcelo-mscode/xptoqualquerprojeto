...
@Controller
@Transactional
public class RelatorioCacheIndexController {
	
	@PersistenceContext	private EntityManager manager;
	@Autowired CacheDAO cacheDAO;
	
	@RequestMapping("relatorioCache")
	public ModelAndView relatorioCache(){
		
		ModelAndView MV = new ModelAndView("financeiro/cache/relatorioIndexCache");
