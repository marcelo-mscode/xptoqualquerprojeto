...
public class ChainVerificaCategoriaImposto {
	...
	public String verifica(boolean imposto,boolean incideAdministracao,boolean feeReduzido){
		...
		T3.setProximo(T4);
		T4.setProximo(T5);
		return T1.verificaCategoria(imposto,incideAdministracao,feeReduzido);
	}
}
