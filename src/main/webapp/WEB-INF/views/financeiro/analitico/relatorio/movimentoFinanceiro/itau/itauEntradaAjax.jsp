...
<table class="table table-hover table-bordered">
    ...
    <tr>
       ...
       <td><button onclick="novoDadosMovimentacao('1','ndMovItau','dataMovItau','descMovItau','valorMovItau','salvaNovaEntrada',${idAnalitico},'outrasdespesas');" class="btn btn-default botaoMais botaoMaisDespesa">+</button> </td>
    </tr>
    <tr>
       <td>NF/ND</td>
