...
<div class="container">
	<span style="font-size: 150px;font-weight: bold;letter-spacing: -15px;">404</span>
	<p>A página solicitada não foi encontrada.</p>
	<p>Volte, verifique os tipos de dados inseridos e tente novamente.</p>
...
<!-- <div class="col-md-8" style="height: 800px;margin-top: 10%;background: #fff;padding-top: 50px;box-shadow: 5px 15px 10px 5px #999">
	...
	<br /><br />
	<div class="back">
		<button class="btn btn-primary botaoVoltar" onclick="inicio(404);" style="margin-left: 15%;">REPORTAR</button>
	</div>
