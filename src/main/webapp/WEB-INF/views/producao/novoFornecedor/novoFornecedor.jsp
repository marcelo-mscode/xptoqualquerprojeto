  ...
  <div class="row">
    ...
    <div class="col-md-7 painel" style="padding: 20px 0 25px 9px;margin-left: 20%;border-right: 1px solid #ddd;">
			...
			<div style="padding: 15px;border-bottom: 1px solid #e5e5e5;margin-bottom: 15px;margin-top: -20px;">
				...
				<h4 class="modal-title fontLight" id="myModalLabel">CADASTRO DE NOVO FORNECEDOR</h4>
			</div>

        <div class="col-md-12">
        	
<!--             <form action="salvaEmpresaLista" method="post" id="salvaEmpresa" enctype="multipart/form-data"> -->
            <form action="" method="post" id="salvaEmpresaLista">
            ...
            <input type="hidden" value="${infoempresa.idEmpresa}" name="idEmpresaAtualiza">
                <div class="form-inline" style="border-bottom: 0px solid #ddd;margin-bottom: 28px;padding-bottom: 10px;">
                    ...
                    <input type="checkbox" class="checkbox ajuste" name="cliente" disabled="disabled">&nbspCliente
                    <input type="checkbox" class="checkbox ajuste" name="fornecedor" id="fornecedorEmpresa" checked="checked" disabled="disabled" >&nbsp&nbspFornecedor
                    <input type="checkbox" class="checkbox ajuste" name="prospect" disabled="disabled">&nbsp&nbspProspect
                    &nbsp |&nbsp <input type="checkbox" name="habilitado" checked="checked" class="checkbox ajuste" disabled="disabled">&nbsp&nbspAtivo
                </div>
                <div class="form-inline">
                 <input type="text" class="form-control font-bold input-587px" name="empresa" placeholder="Nome da Empresa" id="nomeEmpresa" onblur="verificaFornecedor();">&nbsp*
...
<%--                  <c:if test="${infoempresa.fornecedor}"> --%>
             ...
             <div class="divisor-fino"></div>
                ...
                <div class="form-group col-md-12 tira-padding">
                  ...
                  <a class="btn btn-primary display-none" id="fechaFornecedorLista" onclick="tiraLightbox();">Fechar</a>

                  <br><br>
                  
                  <span style="display: none;color: red" id="salvou">Novo fornecedor salvo com sucesso !</span>
