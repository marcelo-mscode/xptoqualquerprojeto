...
<c:forEach items="${estrategia}" var="estrategia">
	...
	<c:set var="tituloJob" value="${estrategia.idJob.titulo}" />
	...
	<c:set var="notificaResponsavel" value="${estrategia.notificaResponsavel}" />
...
<div class="col-md-12 bodyXY" style="height: 35px;">
			...
			<ol class="breadcrumb">
			    ...
			    <li class="active">Edita Estratégia</li>
			</ol>					
		</div>
    </div>
</div>
...
<div class="row painel estilo-painel-job">
	<div class="col-md-12  painel" style="border-bottom: 1px solid #D7D1C8;padding-left: 0;">
		<div class="col-md-4" style="padding-left: 0;padding: 1px;">
			<h4 style="margin-left: 18px;"><i class="glyphicon glyphicon-list-alt icones"></i>ESTRATÉGIA</h4>
	    </div>
	   	<div class="col-md-4" style="padding-left: 0;padding: 1px;margin-left: 25px;margin-top: 4px;">
 ...
 <div class="col-md-10" id="estrategia" style="padding-left: 0">
	...
	<form action="salvaEstrategia" method="post" class="col-md-7" id="formEstrategia">
...
<div class="divisor"></div>
			...
			<div class="form-inline ">
				<span style="font-size: 16px;">Job  </span> <strong
					style="font-size: 14px">${empresa} - ${titulo} </strong><br> <br>
			</div>
				...
				<div class="col-md-12 tira-padding">
					<div class="checkbox">
						...
						<label> 
							...
							<c:if test="${notificaResponsavel == true}">
							    <input type="checkbox" name="notificaResponsavel" checked="checked"> Notificar responsável
							</c:if>

							<c:if test="${notificaResponsavel == false}">
...
<div class="row painel estilo-painel-job">
	...
	<div class="col-md-12 " style="border-bottom: 1px solid #D7D1C8;padding-left: 0;">
		...
		<div class="col-md-4">
			<button class="btn btn-link" style="margin-top: 3px;" id="anexo">[+] Inserir anexo para estratégia</button>
	    </div>
		...
		<form action="recebeAnexo" id="recebeAnexo"  method="post" enctype="multipart/form-data" class="anexo"
			...
			<div class="form-inline">
					...
					<div class="form-group">
						...
						type="text" name="AnexoTitulo" style="width: 427px" placeholder="Título"><br />
					</div>
			...
			<c:when test="${not empty AnexosInternoEstr}">
							...
							<table class="table table-bordered" style="font-size: 12px;">
								...
								<c:forEach items="${AnexosInternoEstr}" var="anexos">
									<tr>
										<td><a href="${anexos.anexoDiretorio}${anexos.anexoArquivo}">${anexos.anexoTitulo}</a></td>
...
<div class="row painel estilo-painel-job">
	...
	<div class="col-md-6" style="margin-top:15px">
		...
		<form action="CadInteracao" id="formInteracao" class="interacao" method="post" style="padding: 10px 10px 20px 0; margin-bottom: 30px;display:none">
								...
								<input type="hidden" name="interacaoOrigem" value="internoEstr"/>
